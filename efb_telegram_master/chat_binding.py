...
class ChatBindingManager(LocaleMixin):
    ...
    async def link_chat_gen_list(self, chat_id: TelegramChatID,
        ...
        if message_id is None:
            message_id = await self.bot.send_message(chat_id, self._("Processing...")).message_id
    ...
    async def link_chat_confirm(self, update: Update, context: CallbackContext) -> int:
        """
    ...
    async def link_chat_exec(self, update: Update, context: CallbackContext) -> int:
        """
    ...
    async def unlink_all(self, update: Update, context: CallbackContext):
        """
    ...
    async def chat_head_req_generate(self, chat_id: TelegramChatID,
        ...
        """
        if message_id is None:
            message_id = await self.bot.send_message(chat_id, text=self._("Processing...")).message_id
        await self.bot.send_chat_action(chat_id, ChatAction.TYPING)
    ...
    async def make_chat_head(self, update: Update, context: CallbackContext) -> int:
        """
    ...
    async def suggested_recipient(self, update: Update, context: CallbackContext):
    ...
    async def update_group_info(self, update: Update, context: CallbackContext):
        """
